...
.. note::
   ...
   all the research done in this box are using a equality filter, if you want to search on a substring you should use the ***** operator

   ex : tin* will search for all peoples starting by tin
