...
You can use advanced configuration to have more filter options

.. image:: images/acl-assignement-add-advanced.png
   :alt: Picture of ACL Assignments add advanced in FusionDirectory

* **Member filter** : you can use (eduPersonAffiliation=student) for example to only authorize student from "all users"
* **Target filter** : you can use (manager=%dn%) for exemple that will give you rights only on objects on which we are manager
