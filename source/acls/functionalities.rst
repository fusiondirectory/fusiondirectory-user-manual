...
* This may be used when «all users» is checked, or when the members contain groups in which there are students and non-students.
* Example: (eduPersonAffiliation=student) to limit to users with student supann affiliation. 
