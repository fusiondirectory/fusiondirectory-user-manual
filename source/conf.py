# -*- coding: utf-8 -*-
#
# FusionDirectory User Manual documentation build configuration file, created by
...
#
# html_title = u'FusionDirectory User Manual v1.3'
...
htmlhelp_basename = 'FusionDirectoryUserManualdoc'
...
man_pages = [
    (master_doc, 'fusiondirectoryusermanual', u'FusionDirectory User Manual Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FusionDirectoryUserManual', u'FusionDirectory User Manual Documentation',
     author, 'FusionDirectoryUserManual', 'One line description of project.',
     'Miscellaneous'),
]
